...
import PerformanceTestGuide from './PerformanceTestGuide';
const DynamicModalChartDemo = dynamic(() => import('../section3/_component-demo/ModalChart'));
...
export default function TableUserDevTool() {
    const [openPerformanceGuide, setOpenPerformanceGuide] = useState(false);
    ...
    return (
        <div className="p-6">
            <Card>
                <div className="mb-6">
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                        ...
                        <Button type='primary' onClick={() => setOpenPerformanceGuide(true)}>Run Performance Test</Button>
                    </div>
            ...
            {isModalOpen && <DynamicModalChartDemo isModalOpen={isModalOpen} setIsModalOpen={setIsModalOpen} type='dynamic' />}
            {openPerformanceGuide &&
                <Modal
                    title="Performance Testing Guide"
                    open={openPerformanceGuide}
                    onOk={() => setOpenPerformanceGuide(false)}
                    onCancel={() => setOpenPerformanceGuide(false)}
                    centered
                >
